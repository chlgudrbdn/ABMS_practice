...
for TRY in range(trycount):
    ...
    class VendingMachine:
        ...
        def price_decision(self, n):
            if self.totalBuyCountLog[-1] == 0:
                self.priceLog.append(firstPrice)
            elif self.priceLog[-1] < maximumPrice:
...
worldA_before = [936200,	1596900,	1750300,	1706700,	1684900,	624200,	2026700,	1789100,	493300,	1207100,	1504000,	830100,	842600,	586100,	1406800,	1220300,	1691300,	1319200,	1785000,	1534400,	1284400,	1769700,	1607400,	1521400,	1454300,	1703500,	1139900,	1617100,	1440000,	1162400]
# 손으로 일일이 계산한 결과 옮겨옴
