...
worldA_before = [790200,	2169600,	1203300,	1319200,	1984200,	235800,	326100,	2150300,	1707700,	1680100,	1460600,	1589800,	1066900,	1497700,	894700,	804000,	1324000,	783500,	1923000,	1110300,	439000,	965300,	1353600,	2429400,	1875200,	1857800,	1828700,	1615700,	1194200,	666300]
# 손으로 일일이 계산한 결과 옮겨옴
RevenueDistributionPerWorld.append(worldA_before)
equ_var_test_and_unpaired_t_test(RevenueDistributionPerWorld[0], RevenueDistributionPerWorld[2])
